...
var file_docs_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x32, 0xb6, 0x01, 0x0a, 0x09, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x73,
	...
	0x73, 0x2e, 0x54, 0x44, 0x6f, 0x63, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x42, 0x1f, 0x5a, 0x1d, 0x77,
	0x6c, 0x63, 0x6d, 0x74, 0x75, 0x6e, 0x6b, 0x6e, 0x77, 0x6e, 0x64, 0x74, 0x68, 0x2e, 0x64, 0x6f,
	0x63, 0x73, 0x2e, 0x76, 0x31, 0x3b, 0x64, 0x6f, 0x63, 0x73, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_docs_proto_depIdxs = []int32{
	...
	1, // 2: documents.Documents.Process:input_type -> documents.TDocument
	1, // 3: documents.Documents.Create:output_type -> documents.TDocument
	1, // 4: documents.Documents.Update:output_type -> documents.TDocument
	1, // 5: documents.Documents.Process:output_type -> documents.TDocument
